package com.chessacademy.ravikrishna.utils;
...
public class MyConstant {
        ...
        public static final String JWT_DESCRIPTION = "Provide the Json Web token.";
        public static final String JWT_BEARER_FORMAT = "JWT";

        // swagger
        public static final String SWAGGER_INFO_TITLE = "chessacademy";
        public static final String SWAGGER_INFO_DESCRIPTION = "My website is a chess academy for the learners";
        public static final String SWAGGER_INFO_VERSION = "1.0.0";
        public static final String SWAGGER_INFO_CONTACT_NAME = "Ravi Krishna B";
        public static final String SWAGGER_INFO_CONTACT_EMAIL = "727721eucs121@skcet.ac.in";
